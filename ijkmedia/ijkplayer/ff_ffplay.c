    ...
    do {
        ...
        if (got_frame) {
                ...
                if(isApmStart && isCanAEC)
                {
                	...
                	if (swr_ctx && isCanAEC)
                	{
                		nRet = swr_convert(swr_ctx, dst_data, dst_nb_samples,
                		...
                		resampled_length = av_samples_get_buffer_size(&dst_linesize, dst_nb_channels,
                			nRet, dst_sample_fmt, 1);
                    ...
                    // av_log(NULL, AV_LOG_ERROR, "Jeffer AEC AudioResampleForAEC time = %lld vm\n",t1-t0);
                }
                // AEC END
                //////////////////////////////////////////////////////////////////////////
